...
//Components
import Produto from "./Components_Menu/Produto";
        ...
        <div className="Menu_corpo">
            ...
            <div className="Produtos_corpo">
                {ListaAlimentos.Populares.map((item)=>{
                    return (<Produto  Qtd_itens={Qtd_itens} Estrelas={item.Estrelas} Nome={item.Nome} Imagem={item.imagem} Preço={item.Preço}/>)
                })}
                
                {Bot_click === false? (ListaAlimentos.Vitrine1.map((item)=>{
                return (<Produto Qtd_itens={Qtd_itens} Estrelas={item.Estrelas} Nome={item.Nome} Imagem={item.imagem} Preço={item.Preço}/>)
                })) : null}

                {Bot_click === false? (ListaAlimentos.Vitrine2.map((item)=>{
                return (<Produto Qtd_itens={Qtd_itens} Estrelas={item.Estrelas} Nome={item.Nome} Imagem={item.imagem} Preço={item.Preço}/>)
                })) : null}

                {Bot_click === false? (ListaAlimentos.Vitrine3.map((item)=>{
                return (<Produto Qtd_itens={Qtd_itens} Estrelas={item.Estrelas} Nome={item.Nome} Imagem={item.imagem} Preço={item.Preço}/>)
                })) : null}

                {Bot_click === false? (ListaAlimentos.Vitrine4.map((item)=>{
                return (<Produto Qtd_itens={Qtd_itens} Estrelas={item.Estrelas} Nome={item.Nome} Imagem={item.imagem} Preço={item.Preço}/>)
                })) : null}

                {Bot_click === false? (ListaAlimentos.Outros.map((item)=>{
                return (<Produto Qtd_itens={Qtd_itens} Estrelas={item.Estrelas} Nome={item.Nome} Imagem={item.imagem} Preço={item.Preço}/>)
                })) : null}
